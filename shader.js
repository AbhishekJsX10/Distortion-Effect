...
export const renderFragmentShader = `
  ...
  void main() {
    ...
    // Keep the text color bright
    vec3 textColor = vec3(0.996, 0.956, 0.721); // #fef4b8 in RGB
    float textIntensity = length(color.rgb - vec3(0.984, 0.454, 0.153)); // Distance from background color
    
    if(textIntensity > 0.1) {
        color.rgb = textColor;
    }
